...
// Swift equivalents for Javascript String operations

// --
// to display values
// javascript uses console.log and string concatenation
// let x = 'some value'
// console.log('x = '+ x);

// simple attempt in swift will fail
// print("x = "+x)  // ERROR! if x is not a string
...
// !!@ No direct equivalent for javascript substring

// Searcing Apple documentation also show this
